...
const FALLBACK_SERVICES: ServicePreview[] = [
  {
    _id: 'fallback-1',
    title: 'AI Website & Landing Pages',
    slug: 'ai-website-landing-pages',
    description: 'Fast, conversion-focused websites with smart onboarding and clear calls to action.',
    icon: '🌐',
    order: 1,
  },
  {
    ...
    slug: 'ai-sales-lead-automation',
    description: 'Automations that capture, qualify, and follow up with leads without manual effort.',
    icon: '🤖',
    order: 2,
  },
  {
    ...
    slug: 'whatsapp-crm-integrations',
    description: 'Connect your operations, support, and sales tools into one reliable workflow.',
    icon: '📲',
    order: 3,
  },
];
...
// async function getServices(): Promise<ServicePreview[]> {
//   try {
//     const services = await client.fetch<ServicePreview[]>(SERVICES_QUERY);
