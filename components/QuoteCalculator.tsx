...
export function QuoteCalculator() {
  ...
  if (done) {
    return (
      ...
      >
        <div className="h-14 w-14 mx-auto rounded-full bg-[#3a5cff]/10 text-[#3a5cff] grid place-items-center">
...
function StepContact({
  ...
  return (
    <div>
      ...
      <div className="mt-5 rounded-xl bg-[#3a5cff]/5 border border-emerald-500/20 p-3 text-xs text-emerald-700 dark:text-emerald-400 inline-flex items-start gap-2">
