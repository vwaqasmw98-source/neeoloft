          ...
          <div>
            ...
            >
              <span className="inline-flex items-center gap-1.5">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#3a5cff]" /> No-code AI trained on your data
              </span>
              <span className="inline-flex items-center gap-1.5">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#3a5cff]" /> 14-day delivery on most projects
              </span>
              <span className="inline-flex items-center gap-1.5">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#3a5cff]" /> Pay in milestones
              </span>
            </motion.div>
          </div>
      ...
      <div className="card relative">
        <div className="flex items-center gap-2 border-b border-slate-200/70 dark:border-slate-800 pb-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#3a5cff] inline-flex items-center gap-1">
              <span className="h-1.5 w-1.5 rounded-full bg-[#3a5cff] animate-pulse-slow" />
