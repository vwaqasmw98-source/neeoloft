...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Yes. We build with a headless CMS ( Payload) for content-driven sites, so you can update text, images, and pages without touching code. For static marketing sites we use MDX so your team can edit with a simple Git workflow.',
  },
  {
